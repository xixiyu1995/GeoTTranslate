...
# lora
model_train = r'.\output\GEO-Qwen3-7+8+32+10+1e-4+cosine+0.1\\checkpoint-5410'
# 加载训练好的模型
...
# 使用新的数据集分割方式
# 总数据集路径
total_dataset_path = 'GNER_data/NERdata_open_all.jsonl'
total_jsonl_new_path = 'GNER_data/NERdata_open_total.jsonl'
...
# 保存为 Excel 文件
excel_output_path = 'prediction_results_all_1081_fine-grain.xlsx'
